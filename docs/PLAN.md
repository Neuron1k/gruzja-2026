# Gruzja — Plan Wycieczki, kwiecień 2026

**9 osób (7 dorosłych + 2 dzieci) · Kutaisi · 2–9 kwietnia 2026**

- Przylot: 2.04 o 11:30 (KUT)
- Wylot: 9.04 o 12:30 (KUT)
- Wielkanoc: niedziela 5.04
...
**Program:**
- Lot KTW–KUT, lądowanie 11:30
- Odbiór auta ~12:30
- Obiad w Kutaisi
- Katedra Bagrati + Biały Most + Kolchis Fountain
- Spacer nad rzeką Rioni

**Jedzenie:**
- **Palaty** ⭐ 4.5 (800) — Obiad: polecana przez lokalsów, otwarta na lunch
- **Sisters** ⭐ 4.3 (1.4k) — Kolacja: muzyka na żywo, piękne wnętrze (otwierają o 18:00!)
- **El Depo** ⭐ 4.5 (1.5k) — Alternatywa: najlepsze khinkali w mieście

**Tips:**
- Spokojny start — dzieci zmęczone po locie
...
**Program:**
- Jaskinia Prometeusza (rano! 40 min jazdy, ~45 min z przewodnikiem)
- Sataplia (po drodze, 10 min od Kutaisi, 1-2h) — dinozaury!
- Kanion Martvili (po południu) — rejs łódką po turkusowej wodzie!

**Jedzenie:**
- **Baraqa** ⭐ 4.4 (1k) — Ogromne menu, rodzinne
- **Palaty** ⭐ 4.5 (800) — Polecana przez lokalsów

**Tips:**
- Prometeusz: 23 GEL/os, opcja rejsu łódką +17 GEL — warto! Przyjechać rano (tłumy w sezonie)
- Sataplia: dinozaury = gwarantowany hit dla 3- i 5-latka! 20 GEL/dorosły, dzieci <6 lat free. Bluza — 14°C w jaskini
...
### Dzień 3 — Sob 4.04 · Przejazd do Tbilisi · (~3h)
...
**Jedzenie:**
- **Keto & Kote** ⭐ 4.4 (2.7k) — Nowoczesna kuchnia gruzińska, World's 50 Best Discovery. REZERWACJA obowiązkowa!
...
### Dzień 4 — Ndz 5.04 · WIELKANOC w Tbilisi · (pieszy!)
...
**Jedzenie:**
- **Barbarestan** ⭐ 4.6 (2.7k) — MUST-HAVE! Kuchnia z XIX-w. książki kucharskiej. REZERWUJ JUŻ!
- **Ethnographer** ⭐ 4.5 (1k) — Supra z muzyką i tańcem na żywo!
- **Mapshalia** ⭐ 4.5 (800) — Autentyczna, nie-turystyczna

**Tips:**
- WIELKANOC KATOLICKA! Zaplanuj coś specjalnego
- Mtatsminda: funicular 15 GEL (obie strony), wstęp free, atrakcje $2-5/szt. Zaplanuj 2-3h!
- Dry Bridge Market: najlepszy w weekendy — ndz wielkanocna = idealna! 30-60 min wystarczy
- Sameba: największa katedra w Gruzji, darmowa. Na Wielkanoc prawosławne nabożeństwo — piękne, ale tłumy
...
### Dzień 7 — Śr 8.04 · Tbilisi – Kutaisi · (~3h)

**Program:**
- Przejazd Tbilisi – Kutaisi (3h)
- Gelati Monastery (UNESCO) — mozaiki!
- Ostatnie zakupy na rynku w Kutaisi
- Churchkhela, wino, przyprawy na prezenty

**Jedzenie:**
- **Bikentia** ⭐ 4.5 (1k) — Legendarny kebab od 1954!
- **Nikhrikia** ⭐ 4.5 (800) — Kultowe mięsne dania od lat 50.
- **Sisters** ⭐ 4.3 (1.4k) — Opcja na kolację: muzyka na żywo, atmosfera na ostatni wieczór
...
### Dzień 8 — Czw 9.04 · Wylot · (~30 min)

**Program:**
- Wyjazd z Kutaisi ~10:30
- Zwrot auta na lotnisku
- Wylot 12:30 — do domu!

**Tips:**
- Min 2h przed lotem (zwrot auta + odprawa)

---

## Budżet

### Transport — porównanie (7 dni)

| Opcja | Koszt 7 dni | /osoba |
|---|---|---|
| **⭐ CheckInKutaisi** — KIA Carnival 9-os, diesel, CDW gratis, foteliki gratis | €350 + ~€200 paliwo = **€550** | **~€61** |
| LocalRent (Starex) — Automat, foteliki 2×$35, dep. $500 | $785 + ~$200 paliwo = ~€900 | ~€100 |
...
| Pozycja | Koszt |
|---|---|
| Transport (CheckInKutaisi) | ~€61 |
| Noclegi (7 nocy) | ~€50–70 |
| Jedzenie (7 dni, ~€10–15/dzień) | ~€70–100 |
| Atrakcje (jaskinia, kanion, łaźnie, cooking) | ~€20–30 |
| Wino / degustacje | ~€15–25 |
| Pamiątki + SIM + ubezpieczenie | ~€25–40 |
| **RAZEM (self-drive)** | **~€250–350** |
| RAZEM (z kierowcą) | ~€350–450 |
| RAZEM (kierowca + przewodnik) | ~€500–600 |

### Atrakcje — rozpiska kosztów

| Atrakcja | Koszt |
|---|---|
| Jaskinia Prometeusza | 23 GEL/os (+17 GEL łódka) |
| Kanion Martvili | ~20 GEL/os (~€7) |
| Łaźnie siarkowe (sala/h) | 70 GEL (~€25) ÷ grupa |
| Cooking class | €20–50/os |
| Supra wielkanocna | $30–50/os |
| Sataplia | 20 GEL/os (dzieci <6 free) |
| Mtatsminda Park | funicular 15 GEL + atrakcje $2–5 |
| Winnica Khareba | umiarkowane |
| Gelati, Mtskheta, Jvari | bezpłatne |

### Ceny w Gruzji

| | |
|---|---|
| Khinkali (1 szt.) | 1–2 GEL (€0.50) |
| Obiad (restauracja) | 25–50 GEL (€9–18) |
| Kawa | 2–6 GEL (€1–2) |
| Piwo (restauracja) | 6–10 GEL (€2–4) |
| Wino (sklep) | 5–12 GEL (€2–4) |
| Taxi (Bolt, krótki) | 6–10 GEL (€2–4) |
...
### Ubrania
- [ ] **Kurtka przeciwdeszczowa (kwiecień = kapryśny!)**
- [ ] Polar / bluza na wieczory (góry chłodne)
- [ ] Wygodne buty do chodzenia (dużo bruku!)
- [ ] Sandały / klapki (łaźnie siarkowe)
- [ ] Koszulki, spodnie na ~20°C dzień / ~8°C noc
- [ ] Czapka z daszkiem / okulary

### Dla chłopców (3 i 5 lat)
- [ ] Przekąski na drogę (dużo!)
- [ ] Lekki wózek spacerowy (opcja)
- [ ] Bluzy zapasowe (khinkali = bałagan)

### Dokumenty
- [ ] **Paszport (min. 6 mies. ważności!)**
- [ ] **Revolut / karta wielowalutowa (GEL!)**
- [ ] Ubezpieczenie podróżne + EKUZ
- [ ] Wydruk rezerwacji (hotel, auto, loty)
- [ ] Prawo jazdy (kat. B wystarczy)

### Apteczka
- [ ] Ibuprofen / paracetamol
- [ ] Leki na biegunkę (zmiana kuchni!)
- [ ] Plastry, środek odkażający
- [ ] Krem z filtrem SPF30+
- [ ] Środek na komary (wieczory nad rzeką)

### W aucie
- [ ] Foteliki — NA MIEJSCU (CheckInKutaisi: gratis!)
- [ ] Nawigacja offline (Maps.me lub Google Maps)
- [ ] Ładowarka USB / powerbank
- [ ] Woda, chusteczki mokre

### Technika
- [ ] SIM / eSIM (Magti/Geocell na lotnisku, ~€5)
- [ ] Powerbank

> Adapter gniazdka NIE jest potrzebny — Gruzja ma takie same gniazdka jak Polska (typ C/F).

---

## Dodatkowe atrakcje (opcjonalne)

| Miejsce | Kategoria | Ocena | Info |
|---|---|---|---|
| Ogród Botaniczny | Atrakcja | ⭐ 4.6 (12.4k) | Za Narikala, ładne spacery. Wodospad w środku! ~5 GEL |
| Kronika Gruzji | Atrakcja | ⭐ 4.8 (12.4k) | Monumentalne kolumny nad Tbilisi Sea. Gruziński Stonehenge! Bezpłatnie |
| Sataplia (dinozaury!) | Dzieci | ⭐ 4.5 (1.1k) | Ślady dinozaurów! + jaskinia + taras widokowy. Blisko Kutaisi |
| Uplistsikhe | Atrakcja | ⭐ 4.7 (11.4k) | Miasto skalne z epoki żelaza! 3000 lat historii. 1h od Tbilisi |
| Borjomi Park | Dzieci | ⭐ 4.6 (15.1k) | Park + wody mineralne ze źródła. Kolejka linowa, baseny. Po drodze Kutaisi–Tbilisi (objazd) |
| Turtle Lake | Dzieci | ⭐ 4.4 (1.6k) | Jeziorko nad Tbilisi, kolejka. Trampoliny, plac zabaw |
| Rike Park | Dzieci | ⭐ 4.7 (15k) | Park nad rzeką Kura. Kolejka linowa do Narikala stąd! Fontanny, plac zabaw |
| Katedra Bagrati | UNESCO | ⭐ 4.7 (5.4k) | XI-wieczna katedra na wzgórzu. Widok na całe Kutaisi |
